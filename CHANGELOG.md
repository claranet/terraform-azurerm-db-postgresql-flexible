...
* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ bf51fcb

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 59dea83
* **deps:** update dependency terraform-docs to v0.23.0 6479306
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 adf323a
* **deps:** update tools a7ca47f
* **pre-commit:** 🔧 move to prek 2c27ad6
* **tfdocs:** bump tfdocs to v0.22 🔧 d612910

## 8.6.2 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 7f58d86

### Code Refactoring

* update module structure and Github actions 👷 1add808

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 8ec6cad
* **deps:** 🔗 bump tflint rules version 3bcf7a3
* **deps:** update dependency opentofu to v1.11.5 9c84541
* **deps:** update dependency trivy to v0.69.2 bc838de
* **deps:** update dependency trivy to v0.69.3 e5d0729
